cmd_arch/arm/boot/msm8974-v2.2-rhine_amami_row.dtb := /home/z/14.4.A.0.108.tar.tar_FILES/kernel/scripts/dtc/dtc -O dtb -o arch/arm/boot/msm8974-v2.2-rhine_amami_row.dtb -b 0  -d arch/arm/boot/.msm8974-v2.2-rhine_amami_row.dtb.d arch/arm/boot/dts/msm8974-v2.2-rhine_amami_row.dts

source_arch/arm/boot/msm8974-v2.2-rhine_amami_row.dtb := arch/arm/boot/dts/msm8974-v2.2-rhine_amami_row.dts

deps_arch/arm/boot/msm8974-v2.2-rhine_amami_row.dtb := \
  arch/arm/boot/dts/msm8974-v2.2.dtsi \
...
arch/arm/boot/msm8974-v2.2-rhine_amami_row.dtb: $(deps_arch/arm/boot/msm8974-v2.2-rhine_amami_row.dtb)
